...
\begin{scope}[xshift=12cm]
  ...
  \path  (0, 0)   node[transition][label=below:A]   (A)  {}
        +(2, 2)   node[place][label=below:B1]  (B1) {}  edge[pre](A)
       ++(2,-2)   node[place][label=below:B2]  (B2) {}  edge[pre](A)
       ++(2, 2)   node[transition][label=below:C]   (C)  {} edge[pre](A) edge[pre](B1);
